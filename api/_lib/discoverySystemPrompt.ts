...
- bootstrap: first turn.
  ...
  - Else if context.statedJourneyIntent is set (user stated an outcome — download, fill, submit, verify… — with or without a deep URL): return 2–3 proposals where **#1 implements statedJourneyIntent**. Keep the user’s destination URL/path. Never put homepage availability or “search from homepage” as #1. Short message; readyForPlan false; plan null.
